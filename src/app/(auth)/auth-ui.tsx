...
const titleMap = {
  login: 'Login to QuantumShield',
  signup: 'Join QuantumShield and start sending secure messages',
} as const;
  ...
  return (
    <section className='mt-16 flex w-full flex-col gap-16 rounded-lg bg-black p-10 px-4 text-center'>
      <div className='flex flex-col gap-4'>
        <div className='rounded-full bg-gradient-to-r from-[#556b9c] to-[#265073] p-4 flex items-center justify-center m-auto'>
          <span className="text-3xl font-bold text-white">Q</span>
        </div>
        <h1 className='text-lg'>{titleMap[mode]}</h1>
        <p className='text-zinc-400'>
          {mode === 'login' 
            ? 'Access your secure messaging account' 
            : 'Create your quantum-safe messaging account'
          }
        </p>
      </div>
      <div className='flex flex-col gap-4'>
        <button
          className='flex items-center justify-center gap-2 rounded-md bg-cyan-600 py-4 font-medium text-white transition-all hover:bg-cyan-500 disabled:bg-neutral-700'
        ...
        <button
          className='flex items-center justify-center gap-2 rounded-md bg-zinc-700 py-4 font-medium text-white transition-all hover:bg-zinc-600 disabled:bg-neutral-700'
